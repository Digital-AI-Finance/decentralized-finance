...
\item L2 transaction costs: \$0.50-2.00 -> \$0.01-0.05
\item User migration to L2s accelerated dramatically
\end{itemize}

\vspace{0.3cm}
\textbf{L2 TVL and Activity (Late 2024):}
\begin{itemize}
\item Combined L2 TVL: ~\$40B (up from \$10B in early 2024)
\item Daily transactions: L2s now exceed Ethereum L1
\item Base (Coinbase): Fastest growing, \$3B+ TVL
\item Arbitrum: Largest by TVL (~\$15B), strongest DeFi ecosystem
\item Optimism: Superchain vision, multiple OP Stack chains
\end{itemize}
...
\item Superchain: Shared sequencer, cross-L2 interoperability
\item ZK maturity: zkSync, Scroll, Linea gaining traction
\item Centralized sequencers remain (decentralization roadmap ongoing)
\end{itemize}
\end{frame}
...
\item \textbf{Current Landscape}: Arbitrum, Optimism, Base lead; ZK rollups maturing
