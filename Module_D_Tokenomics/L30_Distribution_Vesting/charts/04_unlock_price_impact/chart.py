...
ax1.set_xlabel('Days Relative to Unlock Event', fontsize=15)
ax1.set_ylabel('Token Price ($)', fontsize=15, color=MLBLUE)
ax1.tick_params(axis='y', labelcolor=MLBLUE)
ax1.set_ylim(70, 120)

ax2 = ax1.twinx()
ax2.fill_between(days, supply, alpha=0.3, color=MLORANGE, step='post')
ax2.set_ylabel('Circulating Supply (M)', fontsize=15, color=MLORANGE)
...
# Add annotations
ax1.annotate('Front-running\n(selling before)', xy=(-10, 98), fontsize=14, ha='center')
ax1.annotate('Recovery\n(adoption growth)', xy=(20, 95), fontsize=14, ha='center')
