...
\item \textbf{Buybacks}
\begin{itemize}
\item Protocol buys tokens from market
\item Example: MakerDAO buying back MKR
\end{itemize}
\end{enumerate}
\end{frame}
...
\begin{frame}{Supply Models: Inflationary}
\textbf{Characteristics:}
\begin{itemize}
...
\vspace{0.3cm}
\textbf{Ethereum Example (Post-Merge):}
\begin{itemize}
\item New ETH issued to validators: ~0.5\% annually
\item ETH burned via EIP-1559: ~0.5-2\% annually
\item Net effect: slightly deflationary to neutral
\end{itemize}

\vspace{0.3cm}
\textbf{Advantages:}
\begin{itemize}
\item Ongoing incentives for network security
\item Flexibility to adjust issuance
\item Can fund ecosystem development
\end{itemize}
\end{frame}

\begin{frame}{Supply Models: Deflationary}
\textbf{Characteristics:}
\begin{itemize}
...
\item Real-Time Burn: 10\% of gas fees immediately burned
...
\textbf{Risks:}
\begin{itemize}
\item Excessive deflation may discourage spending
\item Burns must be backed by genuine demand
\item Can be manipulated if not transparent
\end{itemize}
\end{frame}
...
\vspace{0.3cm}
\textbf{Implication:}
If $V$ increases while $PQ$ (network activity) stays constant, $M$ (token value) must decrease.
...
\textbf{Goal:} Align interests of all participants (users, developers, investors, validators).

\vspace{0.3cm}
\textbf{Stakeholders:}
\begin{itemize}
\item \textbf{Users:} Want low fees, good UX, reliable service
\item \textbf{Developers:} Need funding, want protocol adoption
\item \textbf{Token Holders:} Seek value appreciation
\item \textbf{Validators/Miners:} Require adequate compensation
\end{itemize}

\vspace{0.3cm}
\textbf{Mechanisms:}
\begin{enumerate}
\item \textbf{Fee Sharing:} Users pay fees, validators/holders earn
\item \textbf{Governance:} All stakeholders can propose changes
\item \textbf{Vesting:} Long-term alignment for team/investors
\item \textbf{Liquidity Mining:} Bootstrap network effects
\end{enumerate}
\end{frame}
...
\vspace{0.3cm}
\textbf{Result:} ETH became an ultrasound money meme due to net deflation.
\end{frame}
...
\item No burns or deflationary mechanisms
\item Unsustainable yield promises (>100\% APY)
\item Complex mechanisms to hide inflation
\end{itemize}
\end{frame}
