...
ax.text(0.4, 0.9, 'SETUP PHASE', ha='center', va='center', fontsize=12, fontweight='bold', color='gray')
ax.text(0.4, 0.1, 'MONITORING PHASE', ha='center', va='center', fontsize=12, fontweight='bold', color='gray')
