...
\begin{itemize}
\item Total DeFi TVL: ~\$80-90 billion (recovered from 2022 lows)
\item Ethereum: ~55\% of TVL
\item Layer 2s (Arbitrum, Base, Optimism): ~15\% combined
\item Solana, BSC: ~5-8\% each
\end{itemize}

\vspace{0.3cm}
\textbf{Top Protocols by TVL (2024):}
\begin{enumerate}
\item Lido (liquid staking): ~\$25B
\item EigenLayer (restaking): ~\$15B (new category)
\item Aave (lending): ~\$12B
\item MakerDAO/Sky (stablecoin): ~\$8B
\item Uniswap (DEX): ~\$5B
\end{enumerate}
\end{frame}
...
\item Staked ETH simultaneously secures Ethereum AND other protocols
\item Introduced by EigenLayer (launched 2023, major growth 2024)
\end{itemize}
...
\item Additional services (AVS) pay for shared security
\item Earn extra yield from securing these services
\item Risk: Slashing if validator misbehaves on any secured service
\end{enumerate}

\vspace{0.3cm}
\textbf{Impact on DeFi:}
\begin{itemize}
\item New primitive: ``Shared security as a service''
\item \$15B+ TVL in EigenLayer by late 2024
\item Liquid Restaking Tokens (LRTs): eETH, rsETH, ezETH
\item Points programs drove massive adoption (airdrop farming)
...
\item TVL measures capital deployed (~\$80-90B in late 2024)
