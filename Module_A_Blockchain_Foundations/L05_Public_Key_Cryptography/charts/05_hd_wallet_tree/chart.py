...
ax.text(0.5, master_y, 'm', ha='center', va='center', fontsize=15, fontweight='bold', color='white')
ax.text(0.58, master_y, "Master Key", ha='left', va='center', fontsize=14, color='#444')
...
ax.text(0.5, purpose_y, "44'", ha='center', va='center', fontsize=14, fontweight='bold', color='white')
ax.text(0.58, purpose_y, "Purpose (BIP-44)", ha='left', va='center', fontsize=14, color='#444')
...
for x, label, name in zip(coin_positions, coin_labels, coin_names):
    ...
    ax.text(x, coin_y, label, ha='center', va='center', fontsize=14, fontweight='bold', color='white')
    ax.text(x, coin_y - 0.08, name, ha='center', va='center', fontsize=14, color='#555')
...
for x, label in zip(account_positions, account_labels):
    ...
    ax.text(x, account_y, label, ha='center', va='center', fontsize=14, fontweight='bold', color='white')
...
for x, label in zip(addr_positions, addr_labels):
    ...
    ax.text(x, addr_y, label, ha='center', va='center', fontsize=14, fontweight='bold', color='#333')
...
for x, y, label, path in labels:
    ax.text(x, y, f'{label}:\n{path}', ha='left', va='center', fontsize=14,
...
ax.text(0.70, 0.90, insight_text, ha='center', va='center', fontsize=14,
