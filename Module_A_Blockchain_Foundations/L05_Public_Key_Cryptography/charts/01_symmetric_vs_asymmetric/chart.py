...
ax1.text(0.15, 0.55, 'Alice', ha='center', fontsize=11, color='#333')
...
ax1.text(0.85, 0.55, 'Bob', ha='center', fontsize=11, color='#333')
...
ax1.text(0.5, 0.71, 'Same Key K', ha='center', va='center', fontsize=11, fontweight='bold', color='white')
...
ax1.text(0.5, 0.40, 'Encrypted Message', ha='center', fontsize=10, color='#666')
...
ax2.text(0.15, 0.55, 'Alice', ha='center', fontsize=11, color='#333')
...
ax2.text(0.85, 0.55, 'Bob', ha='center', fontsize=11, color='#333')
...
ax2.text(0.66, 0.84, 'Public Key', ha='center', va='center', fontsize=10, fontweight='bold', color='white')
...
ax2.text(0.83, 0.56, 'Private Key', ha='center', va='center', fontsize=10, fontweight='bold', color='white')

# Arrow from public key to Alice
ax2.annotate('', xy=(0.23, 0.75), xytext=(0.55, 0.84),
            arrowprops=dict(arrowstyle='->', color=MLGREEN, lw=2))
ax2.text(0.35, 0.85, 'Shared openly', ha='center', fontsize=9, color=MLGREEN)

# Message flow
ax2.annotate('', xy=(0.77, 0.35), xytext=(0.23, 0.35),
            arrowprops=dict(arrowstyle='->', color='#666', lw=2))
ax2.text(0.5, 0.40, 'Encrypted with Public Key', ha='center', fontsize=10, color='#666')
