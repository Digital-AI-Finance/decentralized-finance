...
\textbf{Examples (2024):}
\begin{itemize}
    \item 30M ETH staked: APR $\approx$ 3.7\%
    \item 20M ETH staked: APR $\approx$ 4.5\%
...
\begin{enumerate}
    ...
    \item \textbf{Exchange Dominance:}
    \begin{itemize}
        \item Lido: ~30\% of staked ETH
        \item Coinbase: ~15\%
        \item Top 5 entities: ~60\% of stake
        \item Centralized control risk
    \end{itemize}
