...
ax.text(0.175, 0.85, 'Block Header', ha='center', fontsize=12, fontweight='bold', color=MLPURPLE)
ax.text(0.175, 0.75, 'Prev Hash', ha='center', fontsize=10, color='#333')
ax.text(0.175, 0.68, 'Merkle Root', ha='center', fontsize=10, color='#333')
ax.text(0.175, 0.61, 'Timestamp', ha='center', fontsize=10, color='#333')
...
ax.text(0.175, 0.35, 'NONCE', ha='center', fontsize=13, fontweight='bold', color='white')
ax.text(0.175, 0.25, 'Try: 0, 1, 2, ...', ha='center', fontsize=10, color='white')
ax.text(0.175, 0.18, '(random search)', ha='center', fontsize=9, color='white', style='italic')
...
ax.text(0.50, 0.48, '(twice)', ha='center', fontsize=11, color='white')
ax.text(0.50, 0.40, '256-bit output', ha='center', fontsize=10, color='white', style='italic')
...
ax.text(0.825, 0.58, 'Hash < Target?', ha='center', fontsize=12, fontweight='bold', color='#333')
ax.text(0.825, 0.48, '0000...xyz', ha='center', fontsize=10, family='monospace', color='#555')
ax.text(0.825, 0.40, '(leading zeros)', ha='center', fontsize=10, color='#666')
...
ax.text(0.85, 0.125, 'Valid Block!', ha='center', fontsize=11, fontweight='bold', color='white')

ax.annotate('', xy=(0.85, 0.20), xytext=(0.825, 0.35),
            arrowprops=dict(arrowstyle='->', color=MLGREEN, lw=2))
ax.text(0.90, 0.28, 'YES', fontsize=10, fontweight='bold', color=MLGREEN)

# Failure path (back to nonce)
ax.annotate('', xy=(0.175, 0.15), xytext=(0.70, 0.35),
            arrowprops=dict(arrowstyle='->', color=MLRED, lw=2,
                           connectionstyle="arc3,rad=-0.3"))
ax.text(0.40, 0.08, 'NO -> Try another nonce', fontsize=10, color=MLRED, fontweight='bold')
...
ax.text(0.50, 0.92, insight_text, ha='center', fontsize=11, fontweight='bold',
