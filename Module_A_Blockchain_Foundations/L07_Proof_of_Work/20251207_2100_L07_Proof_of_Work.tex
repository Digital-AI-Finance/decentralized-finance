...
\begin{itemize}
    ...
    \item Bitcoin network (late 2024): ~700 EH/s (all-time high)
\end{itemize}
...
\begin{itemize}
    ...
    \item 4th halving (April 19, 2024): reward reduced to 3.125 BTC
    \item Current (2025): 3.125 BTC per block
...
2028-2032 & 1.5625 BTC & 20.67M BTC \\
\bottomrule
\end{tabular}
...
\begin{itemize}
    \item Block subsidy: 3.125 BTC (since April 2024 halving)
    \item Transaction fees: 0.1-0.5 BTC per block (typical)
    \item Fees: ~3-15\% of total reward (increasing importance)
\end{itemize}
