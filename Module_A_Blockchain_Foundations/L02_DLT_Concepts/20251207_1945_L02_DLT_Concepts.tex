...
\vspace{0.5em}
\textbf{Challenge:} How can loyal generals reach consensus when traitors may send conflicting messages?
\end{frame}
...
\item Scalability bottleneck at hub
\end{itemize}
...
\item Easier to scale geographically
\end{itemize}
...
\item Variable network performance
\end{itemize}
...
\begin{frame}[t]{Block Propagation}
...
\item Contribute to network health
\end{itemize}
...
\textbf{Economics:}
\begin{itemize}
\item Bitcoin block reward: 6.25 BTC (halves every 4 years, next in 2024 $\rightarrow$ 3.125 BTC)
...
\vspace{0.5em}
\textbf{Ethereum 2.0 Validator Requirements:}
\begin{itemize}
