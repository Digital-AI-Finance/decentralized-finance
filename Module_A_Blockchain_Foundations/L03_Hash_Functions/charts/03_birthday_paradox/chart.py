...
ax.annotate(f'50% at n={n_people[idx_50]}', xy=(n_people[idx_50], probs[idx_50]),
            xytext=(35, 0.4), fontsize=15, color=MLORANGE,
...
ax.annotate(f'99% at n={n_people[idx_99]}', xy=(n_people[idx_99], probs[idx_99]),
            xytext=(55, 0.85), fontsize=15, color=MLRED,
...
# Labels
ax.set_xlabel('Number of People (or Hash Samples)', fontsize=16)
ax.set_ylabel('Probability of Collision', fontsize=16)
ax.set_xlim(0, 70)
ax.set_ylim(0, 1.05)
...
ax.text(0.98, 0.35, insight_text, transform=ax.transAxes, fontsize=14,
