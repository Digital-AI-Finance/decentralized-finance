...
\begin{frame}[t]{Six Essential Properties of Cryptographic Hashes}
\begin{center}
\includegraphics[width=0.70\textwidth]{charts/01_hash_properties/chart.pdf}
\end{center}

\vspace{0.3em}
\small
\textbf{Key Insight:} All six properties are required for cryptographic security.
\end{frame}
...
\begin{frame}[t]{Avalanche Effect: Visual Demonstration}
\begin{center}
\includegraphics[width=0.68\textwidth]{charts/02_avalanche_effect/chart.pdf}
\end{center}

\vspace{0.3em}
\small
\textbf{Observation:} 1-bit input change causes approximately 50\% of output bits to flip.
\end{frame}
...
\begin{center}
\includegraphics[width=0.68\textwidth]{charts/03_birthday_paradox/chart.pdf}
\end{center}

\vspace{0.3em}
\small
\textbf{Implication:} Collision resistance scales as $2^{n/2}$, not $2^n$. This is why we need large hash outputs.
\end{frame}
...
\begin{center}
\includegraphics[width=0.78\textwidth]{charts/04_sha256_process/chart.pdf}
\end{center}

\vspace{0.3em}
\small
\textbf{Key Steps:} Padding ensures proper length; compression uses 64 rounds of bitwise operations.
\end{frame}
...
\begin{center}
\includegraphics[width=0.70\textwidth]{charts/05_merkle_tree/chart.pdf}
\end{center}

\vspace{0.3em}
\small
\textbf{Key Insight:} Merkle proofs enable $O(\log n)$ verification of transaction inclusion.
\end{frame}

\begin{frame}[t]{Merkle Tree Construction Algorithm}
...
\begin{frame}[t]{Hash Function Applications Overview}
\begin{center}
\includegraphics[width=0.70\textwidth]{charts/06_hash_applications/chart.pdf}
\end{center}

\vspace{0.3em}
\small
\textbf{Note:} Different applications prioritize different hash properties.
\end{frame}
...
\item Network hash rate: $\approx$ 500 EH/s (exahashes/second)
\end{itemize}
