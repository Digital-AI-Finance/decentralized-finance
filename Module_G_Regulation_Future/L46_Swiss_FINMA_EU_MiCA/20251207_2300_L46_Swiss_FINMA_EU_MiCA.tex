...
\item \textbf{Comparison}: Principles (CH) vs rules (EU), both offer clarity
\item \textbf{Impact}: Institutional adoption enabled, DeFi regulatory gap remains
\item \textbf{Future}: MiCA as global template, DeFi regulation coming
\end{itemize}
\end{frame}
