...
\item \textbf{e-CNY}: Largest pilot, geopolitical implications (USD challenge)
\item \textbf{Digital Euro}: Privacy-focused, launch 2027-2028
\item \textbf{Cross-border CBDCs}: mBridge project (bypass SWIFT)
\item \textbf{Future trends}: Institutional adoption, RWA tokenization, AI+crypto, DePIN, account abstraction
\item \textbf{ZK proofs everywhere}: Privacy + scalability convergence
\item \textbf{Modular blockchains}: Separation of execution, consensus, data availability
\item \textbf{Emerging risks}: Quantum computing, regulatory fragmentation, centralization
