...
ax1.set_ylabel('Daily Active Users (Millions)', color=color1, fontsize=15)
...
ax2.set_ylabel('SLP Price (USD)', color=color2, fontsize=15)
...
ax1.annotate('Ronin\nHack', xy=(5, 0.8), xytext=(5, 1.5),
             fontsize=14, color=MLRED, ha='center',
...
ax1.set_xticks(x)
ax1.set_xticklabels(months, fontsize=14)
