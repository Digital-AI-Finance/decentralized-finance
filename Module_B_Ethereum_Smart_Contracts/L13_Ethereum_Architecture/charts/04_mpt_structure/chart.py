...
ax.add_patch(root)
ax.text(0.50, 0.81, 'Root (Branch)', ha='center', fontsize=14, fontweight='bold', color='white')
...
ax.add_patch(ext)
ax.text(0.24, 0.56, 'Extension', ha='center', fontsize=14, fontweight='bold', color='white')
ax.text(0.24, 0.52, 'path: "a7"', ha='center', fontsize=14, color='white')
...
branch = FancyBboxPatch((0.67, 0.50), 0.18, 0.12,
                         ...
                         edgecolor='black', linewidth=1.5)
ax.add_patch(branch)
ax.text(0.76, 0.56, 'Branch', ha='center', fontsize=14, fontweight='bold', color='white')
ax.text(0.76, 0.52, '16 children', ha='center', fontsize=14, color='white')
...
ax.text(0.35, 0.70, '0xa', fontsize=14, color='#555')

# Root to Branch
ax.plot([0.50, 0.76], [0.75, 0.62], 'k-', linewidth=1.5)
ax.text(0.65, 0.70, '0xb', fontsize=14, color='#555')
...
ax.text(0.22, legend_y + 0.03, 'Branch: 16 children + value', fontsize=14, va='center')

ax.add_patch(FancyBboxPatch((0.45, legend_y), 0.08, 0.06, facecolor=MLORANGE))
ax.text(0.57, legend_y + 0.03, 'Extension: shared prefix', fontsize=14, va='center')

ax.add_patch(FancyBboxPatch((0.75, legend_y), 0.08, 0.06, facecolor=MLGREEN))
ax.text(0.87, legend_y + 0.03, 'Leaf: key + value', fontsize=14, va='center')
