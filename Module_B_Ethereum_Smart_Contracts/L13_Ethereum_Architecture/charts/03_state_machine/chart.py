...
ax.text(0.175, 0.45, 'Block N', ha='center', fontsize=14, color='white')
...
ax.text(0.825, 0.45, 'Block N+1', ha='center', fontsize=14, color='white')
...
ax.add_patch(tx_box)
ax.text(0.50, 0.62, 'Transaction T', ha='center', fontsize=14, fontweight='bold', color='white')

# Formula
ax.text(0.50, 0.78, '$S_{t+1} = Y(S_t, T)$', ha='center', fontsize=16,
        fontweight='bold', color='#333')
ax.text(0.50, 0.88, 'State Transition Function', ha='center', fontsize=15,
        color='#555')

# State components (simplified)
ax.text(0.175, 0.35, 'Balances', ha='center', fontsize=14, color='white')
ax.text(0.175, 0.32, 'Nonces, Code', ha='center', fontsize=14, color='white')

ax.text(0.825, 0.35, 'Updated', ha='center', fontsize=14, color='white')
ax.text(0.825, 0.32, 'Balances, etc.', ha='center', fontsize=14, color='white')
...
for x, step in zip(step_x, steps):
    ...
    ax.text(x, 0.12, step, ha='center', fontsize=14, bbox=props)
...
ax.text(0.50, 0.03, 'Transaction Execution Flow', ha='center', fontsize=14,
