...
ax.text(0.24, 0.65, 'STACK', ha='center', fontsize=11, fontweight='bold', color='white')
ax.text(0.24, 0.55, '256-bit', ha='center', fontsize=9, color='white')
ax.text(0.24, 0.48, 'words', ha='center', fontsize=9, color='white')
ax.text(0.24, 0.38, 'Max 1024', ha='center', fontsize=9, color='white')
ax.text(0.24, 0.30, 'items', ha='center', fontsize=9, color='white')
...
ax.text(0.46, 0.65, 'MEMORY', ha='center', fontsize=11, fontweight='bold', color='white')
ax.text(0.46, 0.50, 'Byte array', ha='center', fontsize=9, color='white')
ax.text(0.46, 0.40, 'Volatile', ha='center', fontsize=9, color='white')
ax.text(0.46, 0.30, '(per call)', ha='center', fontsize=9, color='white')
...
ax.text(0.68, 0.65, 'STORAGE', ha='center', fontsize=11, fontweight='bold', color='white')
ax.text(0.68, 0.50, 'Key-Value', ha='center', fontsize=9, color='white')
ax.text(0.68, 0.40, 'Persistent', ha='center', fontsize=9, color='white')
ax.text(0.68, 0.30, '(on-chain)', ha='center', fontsize=9, color='white')
...
pc_box = FancyBboxPatch((0.81, 0.45), 0.08, 0.25,
                         ...
                         edgecolor='black', linewidth=1.5)
ax.add_patch(pc_box)
ax.text(0.85, 0.60, 'PC', ha='center', fontsize=10, fontweight='bold', color='white')
ax.text(0.85, 0.50, 'Code', ha='center', fontsize=8, color='white')

# Gas meter
ax.text(0.85, 0.38, 'GAS', ha='center', fontsize=10, fontweight='bold', color=MLRED)
ax.text(0.85, 0.30, 'Meter', ha='center', fontsize=8, color='#555')
