...
ax.text(0.11, 0.65, 'Users', ha='center', va='center', fontsize=14, fontweight='bold')
...
ax.text(0.38, 0.50, 'Storage', ha='center', va='center',
        fontsize=14, color='#FFE', fontweight='bold')
...
ax.text(0.22, 0.70, 'Call', fontsize=14, ha='center')
...
ax.text(0.53, 0.44, 'delegatecall', fontsize=14, ha='center', color=MLGREEN, fontweight='bold')

# Admin -> Proxy (upgrade)
ax.annotate('', xy=(0.48, 0.72), xytext=(0.80, 0.72),
           arrowprops=dict(arrowstyle='->', color=MLORANGE, lw=2))
ax.text(0.64, 0.78, 'upgradeTo(v2)', fontsize=14, ha='center', color=MLORANGE, fontweight='bold')
...
# Labels
ax.text(0.05, 0.95, 'Transparent Proxy Pattern', fontsize=14, color='#666',
