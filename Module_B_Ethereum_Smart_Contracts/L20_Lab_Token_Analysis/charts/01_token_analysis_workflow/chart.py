...
exercises = ['Setup\nTools', 'Ex 1: Token\nDiscovery', 'Ex 2: Contract\nAnalysis', 'Ex 3: Holder\nDistribution', 'Report']
durations = [10, 25, 30, 25, 10]
...
ax.set_title('Token Analysis Lab: 100 Minutes', fontweight='bold', fontsize=14)
plt.tight_layout()
